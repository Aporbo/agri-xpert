    ...
    >
      <div className="bg-white/90 backdrop-blur-sm p-8 rounded-xl shadow-2xl w-full max-w-md border border-green-100 transform transition-all hover:scale-[1.01]">
        <div className="flex flex-col items-center mb-6">
          ...
          <h2 className="text-3xl font-bold text-center text-gray-800 mt-2">Create Account</h2>
          <p className="text-gray-600 mt-1">Join our agriculture community</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              <select
                ...
                name="role"
                onChange={handleChange}
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition appearance-none bg-white"
              >
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-600">
            ...
            <Link to="/login" className="text-green-600 hover:text-green-800 font-medium hover:underline">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
