...
const FarmerProfile = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto p-4 md:p-6 space-y-6">
      <h2 className="text-2xl md:text-3xl font-bold text-green-700 flex items-center gap-2">
      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="w-full md:w-48 space-y-2">
          <button
            ...
            className={`w-full text-left px-4 py-2 rounded-lg ${activeTab === 'profile' ? 'bg-green-100 text-green-700' : 'hover:bg-gray-100'}`}
          >
            Profile Information
          </button>
          <button
            onClick={() => setActiveTab('password')}
            className={`w-full text-left px-4 py-2 rounded-lg ${activeTab === 'password' ? 'bg-green-100 text-green-700' : 'hover:bg-gray-100'}`}
          >
            Change Password
          </button>
        </div>
